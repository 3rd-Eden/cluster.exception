...
History.prototype.toGraph = function(key){
  ...
  switch (key){
    ...
    case 'cpus':
      data[0].forEach(function(cpu, index){
      ...
      Object.keys(tmp).forEach(function(cpu){
        ...
        tmp.highest = 0;
        for (time in times){
          tmp.sorted = times[time].sort(function(a,b){return b - a });
